...
class Randomize:
    ...
    @staticmethod
    def random_obstacles_rectangle(env: Grid, n_obstacles: int, max_size: int = 40, min_size: int = 10) -> Grid:
    ...
    @staticmethod
    def random_obstacles_ellipse(env: Grid, n_obstacles: int, max_size: int = 15, min_size: int = 5) -> Grid:
