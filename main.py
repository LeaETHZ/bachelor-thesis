...
if __name__ == '__main__':
    ...
    randomize.build_obstacle((0,30),(60,120),env)
    
    
    robot = planner_factory.build_planner('ExactRobot', 'VaryingLength', 'RegularRes','MinPad')
    ...
    if PolygonAgent.is_in_collision((start[0], start[1], 0),robot.local_shape_up, env, robot.resolution, robot.padding):
